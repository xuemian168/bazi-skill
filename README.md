...
- 多流派会诊：复杂命理任务先由“裁判规划器”选择角色、参考和校验步骤，再让多个主流流派“大师”分别解读，最后由“裁判”综合输出，避免简单拼接或平均分。
...
- 多流派大师会诊：先由裁判规划器决定是否调用子平格局、旺衰扶抑、调候、盲派象法、刑冲合害、神煞辅助、纳音、紫微、现代/传统西洋占星、奇门、六爻、择日、合盘等角色，最终由裁判综合。
